        ...
        <div className={styles.overlay}>
            <div className={styles.modal}>
                ...
                <div className={styles.editTitle}>
                    <b>Q. </b><input className={styles.titleInput} value={title} onChange={(e) => setTitle(e.target.value)} />
                </div>
                <div>
                    <textarea className={styles.contentsInput}
                        value={contents}
                ...
                <div className={styles.buttons}>
                    ...
                    <button className={styles.cansleButton} onClick={onClose}>취소</button>
                </div>
            </div>
        </div>
    );
